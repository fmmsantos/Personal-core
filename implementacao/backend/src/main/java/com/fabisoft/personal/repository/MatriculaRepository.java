...
import com.fabisoft.personal.domain.Matricula;

public class MatriculaRepository implements JpaRepository<Matricula, Long>{
	...
	@Override
	public List<Matricula> findAllById(Iterable<Long> ids) {
		// TODO Auto-generated method stub
		return null;
	}
